...
set key left top
plot "LDmj_sim.ener" every ::1 u 2:7 lw 2 title "TE" w l, \
"LDmj_sim.ener" every ::1 u 2:5 lw 2 title "PE" w l, \
"LDmj_sim.ener" every ::1 u 2:6 lw 2 title "KE" w l
...
#"LDmj_sim.ener" u 2:4 lw 2 title "P"
set xtics font "Times-Roman, 18"
set ytics font "Times-Roman, 18"
set xlabel "time" font "Times-Roman, 20" 
