...
plt.hold(True)
plt.title('Metropolis MC Simulation (U), $ \\beta=0.1$', fontsize=18)
plt.xlabel('Moves',    fontsize=16)
plt.ylabel('$\\langle U \\rangle$',        fontsize=16)
plt.legend(loc='best', fontsize=16)
plt.savefig('Oscillator2a-U.png',dpi=300)
plt.show()
...
ax[0].set_title('Metropolis MC Simulation ($x, x^2$), $\\beta=0.1$', fontsize=18)
